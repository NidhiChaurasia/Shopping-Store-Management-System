...
class Application:
    def __init__(self, master, *args, **kwargs):
        ...
        # components
        self.heading = Label(self.left, text="Shopping Store", font=('arial 40 bold'), bg='white')
        self.heading.place(x=0,y=0)
        
        self.date_1 = Label(self.right, text="Today's Date: "+ str(date), font=('arial 16 bold'),bg='lightblue', fg='black')
        self.date_1.place(x=0,y=0)
        
        # table invoice =========================================================
        self.tproduct = Label(self.right, text="List Of Products", font=('arial 18 bold'), bg='lightblue', fg='black')
        ...
        #enter stuff
        self.enterid = Label(self.left, text="Enter ProductID", font=('arial 18 bold'), bg='white')
        ...
        # total label
        self.total_1 = Label(self.right, text="", font=('arial 40 bold'), bg='lightblue', fg='black')
    ...
    def ajax(self, *args, **kwargs):
       ...
       #create the quantity and the discount label
        ...
        self.bill_btn = Button(self.left, text="Generate Bill", width=90, height=2, bg='black', fg='white' , command=self.generate_bill)
        self.bill_btn.place(x=10, y=640)
    ...
    def generate_bill(self, *args, **kwargs):
        ...
        directory = "D:/Store Management System/Invoice/" + str(date) + "/"
        if not os.path.exists(directory):
            os.makedirs(directory)
            
        #TEMPLATES FOR THE BILL
        company = "\t\t\t\tEnterprise Shopping Store Pvt. Ltd.\n"
